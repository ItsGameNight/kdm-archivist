<template>
  <div class="editable-list-wrapper">
    <ul class="editable-list">
      <editable-list-item v-for="(item, index) in listItems" :initTextValue="item" :key="index" @update="updateItem(index, $event)" @delete="deleteItem(index)"></editable-list-item>
    </ul>
